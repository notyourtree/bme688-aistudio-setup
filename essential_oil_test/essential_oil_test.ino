 ...
 */
#include "2022_08_01_14_13_bsec_Grapefru_Spearmin_Fir_Need_2_0_6_1.h"
...
const String gasName[] = { "Fir Needle", "Grapefruit", "Spearmint", "Undefined 4"};

/* Entry point for the example */
void setup(void)
{
  /* Desired subscription list of BSEC2 outputs */
    bsecSensor sensorList[11] = {
